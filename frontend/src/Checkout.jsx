...
useEffect(() => {
  ...
  const isMomoReturn = urlParams.get("momo") === "success";

  const pending = localStorage.getItem("pendingCartClear");

  if (pending === "true" && isMomoReturn && cart.length > 0) {
    localStorage.removeItem("pendingCartClear");
